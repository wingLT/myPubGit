    ...
    <div class="content">
      <div class="cont-lf">
        ...
        <div class="track-cont">
          ...
          <div id="FGrealtimeTrack" class="realtime-track"></div>
        </div>
      </div>
      <div class="cont-lr">
...
function creatMap(self,dotArr) {
  ...
  map = new fengmap.FMMap({
    //渲染dom
    container: document.getElementById("FGrealtimeTrack"),
    //地图数据位置
