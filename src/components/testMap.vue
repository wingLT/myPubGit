<template>
  <div id="contentMap" class="body-bg">
  </div>
</template>
...
function drawContentMap(self){
  let chinaMap = echarts.init(document.getElementById("contentMap"));
  // 中国为中心
var startPoint = {
    x: 104.114129,
    y: 37.550339
...
// var map = chinaMap.getModel().getComponent('bmap').getBMap();
let map = new BMap.Map('contentMap');
